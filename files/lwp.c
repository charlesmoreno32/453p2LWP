...
tid_t lwp_create(lwpfun function, void *argument){
	...
	if (getrlimit(RLIMIT_STACK, &rlim) == 0) {
		...
		// RLIMIT_STACK does not exist or is RLIM_INFINITY
	...
	thread new_thread = {NUM_THREADS, stack, howbig, };
...
limit rlim;
	...
	//thread new_thread = {NUM_THREADS, stack, };
